...
/**
 * <p>
 * A {@link WebElementHandler} facilitates setting and checking values of {@link WebElement}s. The
 * actual action taken depends on the {@link StepMode}.
 * </p>
 * <p>
 * <strong>Warning: {@link WebElementHandler} instances are always immutable</strong>.;
 * Configuration methods have no effect on the instance they are invoked on! You must store and use
 * the new {@link WebElementHandler} instance returned by these methods. This makes
 ...
 * public static final WebElementHandler BASE_ELEMENT_HANDER = WebElementHandler.create().enabled(true).displayed(true).timeout(10L, 500L);
 * 
 ...
 * 
 * 	protected WebElementHandler elementHandler;
 * 
 * 	&#064;Override
 ...
 * 
 * <pre>
 * WebElementHandler handler = WebElementHandler.create().by(someBy);
...
public final class WebElementHandler {
	 ...
	 * @return the new {@link WebElementHandler} instance
	 */
	public WebElementHandler webDriver(final WebDriver theWebDriver) {
	 ...
	 * @return the new {@link WebElementHandler} instance
	 */
	public WebElementHandler by(final By theBy) {
		Fields fields = new Fields(this);
	...
	/**
	 * Creates a new {@link WebElementHandler} based on this {@link WebElementHandler} that
	 * restricts the enabled status of ele.ments
	 * 
	 * @param theEnabled
	...
	/**
	 * Creates a new {@link WebElementHandler} based on this {@link WebElementHandler} that requires
	...
	public WebElementHandler value(final String theValue) {
		checkState(dataSet == null, "Cannot specify value directly because a DataSet is already associated with this WebElementHandler.");
	 ...
	 * @return the new {@link WebElementHandler} instance
	 */
	public WebElementHandler dataSet(final DataSet theDataSet) {
	 ...
	 * {@link WebElementHandler}.
	 * 
	 * @param theDataKey
	 *            the data set key used to retrieve the value from the specified data set
	 * @return the new {@link WebElementHandler} instance
	 */
	public WebElementHandler dataKey(final String theDataKey) {
	 ...
	 * associated with this {@link WebElementHandler}.
	 * 
	 * @param theDataKey
	 *            the data set key used to retrieve the value from the specified data set
	 * @param theDataIndex
	 ...
	 * @return the new {@link WebElementHandler} instance
	 */
	public WebElementHandler dataKeyWithIndex(final String theDataKey, final Integer theDataIndex) {
		checkState(dataSet != null, "Cannot specify a data key. Please specify a DataSet first.");
